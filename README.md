...
2. Configure the JavaFX SDK in your project settings. *Some IDEs, like IntelliJ IDEA or Eclipse, often have built-in features to configure JavaFX. Check your IDE documentation for how to set up JavaFX for your project.*
...
<img src="graphics/jetlag-home.png" width="75%" />

### Searching for Flights
Enter (or click the box and scroll to find) the desired departure and arrival airports in the search boxes. 
...
<img src="graphics/jetlag-search.png" width="75%" />


### Viewing Results
Click the `Find` button to display flight information. 

<img src="graphics/jetlag-result.png" width="75%" />

Click the `Clear` button to clear the result and search boxes, resetting the application.
